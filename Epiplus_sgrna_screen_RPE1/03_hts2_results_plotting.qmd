---
title: "CENPC Screen - TERT-RPE1 - sgRNA Epigenetics Plus - downstream_Analysis"
...
```{r}
write_csv(all_tbl, "knitr_output/rpe1_all_genes.csv")
```
...
write_csv(putative_hits_k, "knitr_output/rpe1_putative_hits_k.csv")
...
write_csv(putative_hits_n, "knitr_output/rpe1_putative_hits_n.csv")
...
write_csv(putative_hits_r, "knitr_output/rpe1_putative_hits_r.csv")
