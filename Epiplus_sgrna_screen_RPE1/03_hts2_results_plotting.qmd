---
title: "CENPC Screen - hTERT-RPE1 - sgRNA Epigenetics Plus - downstream_Analysis"
...
```{r}
here::i_am("Epiplus_sgrna_screen_RPE1/03_hts2_results_plotting.qmd")
```
...
hts2_output_path <- here("Epiplus_sgrna_screen_RPE1", "hts2_output")
...
```{r}
write_csv(all_tbl, here("Epiplus_sgrna_screen_RPE1", "knitr_output", "rpe1_all_genes.csv"))
```
