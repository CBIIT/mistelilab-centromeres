---
title:  CENPC Screen - HCT116 -  sgRNA Epigenetics Plus - cellHTS2 analysis
...
calculate_HTS2 <- function(
  ...
  obj <- readPlateList(
    ...
    name = meas_select,
    path = fs::path(in_dir, meas_select)
  )
  ...
  cellHTS2_report <- writeReport(
    ...
    force = TRUE,
    mainScriptFile = "HTS2_Analysis.Rmd"
  )
